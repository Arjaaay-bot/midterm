...
<head>
    ...
    <link href="../public/images/ArchDevLogo.png" rel="icon">
...
<style>
    ...
    background-color: #007bff; /* Set to the desired background color */
    color: #fff !important; /* Set to the desired text color and use !important to override Bootstrap styles */
}
.btn-danger {
...
.btn-primary:hover
 {
    background-color: #007bff; /* Keep the same background color as the normal state */
    color: #fff !important; /* Keep the same text color as the normal state and use !important to override Bootstrap styles */
}
.btn-close {
    color: #000; /* Set to the desired text color */
}

.btn-close:hover {
    color: #000; /* Keep the same text color as the normal state */
}
            ...
            <div id="universityTable" class="h-full">
                ...
                <div class="overflow-y-auto max-h-full">
                    <table class="min-w-full divide-y divide-gray-200" id="myDataTable">
                        <thead>
                            <tr>
                                <th style="background-color: #3490dc; color: white;" class="px-6 py-3 text-left text-xs leading-4 font-medium uppercase tracking-wider">
                                Project Name
                                </th>
                                <th style="background-color: #3490dc; color: white;"
...
<script>
 ...
 // Show the edit modal when clicking the edit button
